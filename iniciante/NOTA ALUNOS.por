programa {
  funcao inicio() {
    ...
    real np1,np2,np3,np4,np5 //nota segundo bimestre
    real np1,np2,np3,np4,np5 //nota terceiro bimestre
    real np1,np2,np3,np4,np5 //nota quarto bimestre
    cadeia s1,s2,s3,s4,s5   //série de cada aluno 
...
leia(ns4)
escreva ("Qual a nota do segundo primeiro bimestre do ", a5, "?:")
leia(ns5)
